 ...
 * The class is rewrittent for the vtiger use as Joomlabridge_JCrypt_Helper
 * @package     Joomla.Platform
 * @subpackage  Crypt
 * @since       12.1
 */
class Joomlabridge_JCrypt_Helper {
	/**
	...
	public static function hasStrongPasswordSupport()
	{
		...
		if (!defined('PASSWORD_DEFAULT'))
		{
			...
			include_once 'modules/Joomlabridge/helpers/password.php';
		}
